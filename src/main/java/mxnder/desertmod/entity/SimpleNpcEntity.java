...
// Простая сущность NPC (GeoEntity с анимациями)
public class SimpleNpcEntity extends PathAwareEntity implements GeoEntity {

    // Текущий вариант анимации (изменить в setAnimVariant)
    ...
    // Названия анимаций (должны совпадать с .animation.json)
